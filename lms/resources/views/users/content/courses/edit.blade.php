...
@section('main-content')
            ...
            <div class="card card-primary ">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{route('users.courses.update',$courses->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                  ...
                  <div class="col-lg-7  float-lg-left">
                        ...
                        <div class="form-group">
                          ...
                          <input type="name" class="form-control" name="title" id="cat-name" placeholder="Enter Title" value="{{$courses->title}}">
                         </div>
                       ...
                       <label  for="course-price">Price</label>
                          <input type="number" class="form-control" id="course-price" name="price" placeholder="Enter Price" value="{{$courses->price}}">
                         </div>
             
                         <div class="form-group">
                          <label for="course-desc">Description</label>
                          <textarea class="row-3 form-control" name="description">{{$courses->description}}</textarea>
                         </div>
                  </div>
